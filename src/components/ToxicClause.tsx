type ToxicClauseProps = {
  ...
  export default function ToxicClause({ title, description, confirmText }: ToxicClauseProps) {
    return (
      <div className="w-full max-w-xs inline-flex flex-col justify-start items-start gap-3 px-4">
        ...
        <div className="flex justify-start items-center gap-2 px-1 whitespace-nowrap">
          ...
          <label
            ...
            className="text-white text-sm font-normal font-inter leading-tight truncate max-w-xs cursor-pointer"
          >
            {confirmText}
          </label>
        </div>
